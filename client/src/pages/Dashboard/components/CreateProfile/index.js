...
//Redux imports
import { createProfile } from "../../../../store/modules/profile/actions";
...
const CreateProfile = ( { history } ) => {
  ...
  const onCreateProfile = (formData,history) => dispatch(createProfile(formData,history));
  ...
  return (
    <>
      ...
      <form className="form" onSubmit={handleSubmit}>
        ...
        <input type="submit" value="Create" className="btn btn-primary my-1" />
